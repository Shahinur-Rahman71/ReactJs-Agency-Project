      ...
      <div className="App">
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top bg-dark" id="mainNav">
          <div className="container">
            <a className="navbar-brand js-scroll-trigger" href="#page-top">ReactJs Coder</a>
        ...
        <header className="masthead">
          <div className="container">
            <div className="intro-text">
              ...
              <div className="intro-heading text-uppercase">It's Helpful To Meet You</div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-4">
                <ul className="list-inline quicklinks">
                  ...
                  <li className="list-inline-item">
                    <a href="#something">Shahinur Rahman</a>
                  </li>
                </ul>
              </div>
            </div>
